...
CREATE TABLE [dbo].[GroupCommunicationRequest](
	[GroupCommunicationRequestId] [integer]  IDENTITY(1,1) NOT NULL,
	[SignOffDate] [date] NULL,
	[CreateDateTimeOffset] [datetimeoffset](3) NOT NULL,
	[CommunicationId] [int] NOT NULL,
	[AppUserId] [int] NOT NULL,
 	CONSTRAINT [PKGroupCommunicationRequest] PRIMARY KEY CLUSTERED ([GroupCommunicationRequestId] ASC)
)

GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Table to contain group requests that require a sign off or workflow pertaining to a communication' , 
@level0type=N'SCHEMA',@level0name=N'dbo', 
@level1type=N'TABLE',@level1name=N'GroupCommunicationRequest'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'ID field for each group communication request' , 
@level0type=N'SCHEMA',@level0name=N'dbo', 
@level1type=N'TABLE',@level1name=N'GroupCommunicationRequest', 
@level2type=N'COLUMN',@level2name=N'GroupCommunicationRequestId'
GO
